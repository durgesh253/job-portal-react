...
function Profile() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <h2 className="text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
      Read trusted reviews from Compnies Owner
    </h2>
      ...
      <div className="mb-8 sm:break-inside-avoid">
        <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            <img
              alt="Man"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4SyD0ND-nVnnqoyhiGRd10vSflaT9cwS7ky1YQknPzG9HglFyFoR137gvBXaAKOwHLL0&usqp=CAU"
              className="h-14 w-14 rounded-full object-cover"
            />
      ...
      <div className="mb-8 sm:break-inside-avoid">
        <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            <img
              alt="Man"
              src="https://www.shutterstock.com/image-photo/isolated-portrait-stylish-young-mixed-260nw-640007002.jpg"
              className="h-14 w-14 rounded-full object-cover"
            />
      ...
      <div className="mb-8 sm:break-inside-avoid">
        <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            <img
              alt="Man"
              src="https://media.istockphoto.com/id/1289220974/photo/joyful-natural-young-woman-smiling.jpg?s=612x612&w=0&k=20&c=y8HSzmDzDcSZd9MzZb9N7oPQaUxHaNUtAGBwRuE5wHY="
              className="h-14 w-14 rounded-full object-cover"
            />
